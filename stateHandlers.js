...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to the Music Player. You can say, play the audio to begin the music.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Music Player. You can say, play the audio to begin the music.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the Music Player. You can say, Next or Previous to navigate through the playlist. ' +
    ...
    resumeDecisionModeIntentHandlers : Alexa.CreateStateHandler(constants.states.RESUME_DECISION_MODE, {
        ...
        'AMAZON.StopIntent' : function () {
            var message = ' Thank you for listening Music Player. Good Bye.';
            this.response.speak(message);
            this.emit(':responseReady');
        },
        'AMAZON.CancelIntent' : function () {
